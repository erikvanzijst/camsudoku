...
public interface SolutionsCollector<T> {
    ...
    /**
     * Invoked by the {@link cx.prutser.sudoku.Solver} when a new solution is
     * found. This callback is invoked synchronously during the search process.
     * The supplied {@link cx.prutser.sudoku.SolverContext} instance provides
    ...
    /**
     * Called by the {@link cx.prutser.sudoku.Solver} when the entire puzzle
